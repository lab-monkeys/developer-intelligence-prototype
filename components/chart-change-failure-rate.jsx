...
export function ChartChangeFailureRate() {
  return (
      ...
      <CardContent className="h-full">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={data} margin={{ top: 24, right: 48, left: 24, bottom: 0 }}>
            ...
            <XAxis dataKey="date">
              <Label value="Calendar date" offset={0} position="insideBottom" />
            </XAxis>
            <YAxis>
              <Label value="Completion time (days)" angle={-90} position="insideLeft" style={{ textAnchor: 'middle' }} />
            </YAxis>
            <Tooltip />
            {/* <Legend layout="vertical" verticalAlign="middle" align="right" /> */}
            <Area type="monotone" dataKey="expected_range" fill="#ECEFF1" stroke="#ECEFF1" />
            <Line type="monotone" dataKey="goal" dot={false} stroke="#263238" strokeWidth={2} strokeDasharray="3 3" strokeLinecap="round" />
