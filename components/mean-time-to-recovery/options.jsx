        ...
        <div>
          <div className="mb-6">
            <div className="flex items-center justify-between">
              <Label htmlFor="mean-time-to-recovery-goal">Time to recover from a failure in production?</Label>
              <span className="text-sm font-semibold">{goal} days</span>
            </div>
            <Slider id="mean-time-to-recovery-goal" defaultValue={[0]} value={[goal]} max={28} step={1} className="py-4" onValueChange={(value) => setGoal(value)} />
          ...
          <div className="px-4 py-3 mb-6 border border-dashed border-neutral-300 rounded-lg text-sm text-center italic dark:border-neutral-700">Plan to decrease mean time to recovery by #days per week</div>
        </div>
