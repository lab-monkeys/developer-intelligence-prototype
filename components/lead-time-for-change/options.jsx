...
export function LeadTimeForChangeOptions(props) {
    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Lead time for change</DialogDescription>
        </DialogHeader>
        <div>
          <div className="mb-6">
            <div className="flex items-center justify-between">
              <Label htmlFor="lead-time-for-change-goal">Speed for any change to get into production?</Label>
              <span className="text-sm font-semibold">{goal} days</span>
            </div>
            <Slider id="lead-time-for-change-goal" defaultValue={[0]} value={[goal]} max={28} step={1} className="py-4" onValueChange={(value) => setGoal(value)} />
            <div className="grid grid-cols-3 items-center justify-between text-xs text-neutral-500">
              <span>0</span>
              <span className="flex justify-center">14</span>
          ...
          <div className="px-4 py-3 mb-6 border border-dashed border-neutral-300 rounded-lg text-sm text-center italic dark:border-neutral-700">Plan to decrease lead time for change by #days per week</div>
        </div>
